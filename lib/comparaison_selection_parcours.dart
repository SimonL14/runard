...
import 'package:runard/compare.dart';
...
class compSelectParc extends StatelessWidget {
  ...
  compSelectParc{required this.id});
  @override
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => Compare(id: snapshot.data!.item2[i].parcoursid),
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                SizedBox(height: 7),
                                Text("Selectionner",style: TextStyle(fontSize: 20,color: Colors.white)),
                              ],
                            ),
                          ),
                        ),
